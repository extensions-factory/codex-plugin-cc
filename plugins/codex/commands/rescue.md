...
argument-hint: "[--background|--wait] [--resume|--fresh] [--worker <name>] [--model <model>] [--effort <none|minimal|low|medium|high|xhigh>] [what Codex should investigate, solve, or continue]"
