...
function printUsage() {
  console.log(
    [
      ...
      "  node scripts/codex-companion.mjs task [--background] [--write] [--resume-last|--resume|--fresh] [--worker <name>] [--model <model>] [--effort <none|minimal|low|medium|high|xhigh>] [prompt]",
